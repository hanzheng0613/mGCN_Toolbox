...
from utils.process import split_data
...
training_id, valid_id, test_id = split_data(len(sample_data.labels),train_percent=args.training_ratio,valid_percent = 0.1)
